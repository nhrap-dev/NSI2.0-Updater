...
database = 'HI'
xlsx_hi = r'E:\Projects\NSI_20200200\data\NSI2.0_to_tsNsiGbs_HI.xlsx'
#For CA
...
#OUTPUTS
outputCsvPath = r'E:\Projects\NSI_20200200\data\HI15testoutput.csv'
...
#load config file...
df_config = pd.read_excel(xlsx_hi)
...
#        df_Csv.loc[whereClause, 'eqsbtid'] = eqSBTID
        ...
        #Set eqSBTID value...
        if(pd.isnull(designLevel)):
           df_Csv.loc[(df_Csv['occupancy5'] == SOccupID) & \
...
#The defaults are not getting assigned. Many Null eqsbtid rows are bldgtype = 'H', what is the rule for that?
